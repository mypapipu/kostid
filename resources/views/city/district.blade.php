...
@section('content')
	...
	<div ng-app="districtApp" ng-controller="districtController">
        ...
        <div class="row gray">
            <div class="concon">
                <p><a href="{{url()}}">Home</a> &gt; <a href="{{url($city)}}">{{$city}}</a> &gt; {{$district}} </p>
            </div>
        </div>
	...
	<script>
		var districtApp = angular.module('districtApp', [], function($interpolateProvider) {
	        $interpolateProvider.startSymbol('[[');
	        $interpolateProvider.endSymbol(']]');
	    });
		districtApp.controller('districtController', function($scope, $http) {
